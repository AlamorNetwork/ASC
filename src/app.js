    ...
    try {
      ...
      if (homeless.length) {
        ...
        if (homeless.some((r) => r.role === 'embed' || r.role === 'rerank')) {
          L.push('<i>بعضی ارائه‌دهنده‌ها امبدینگ و ریرنکر دارند ولی در فهرست پیش‌فرضشان نمی‌آورند ' +
            '— آن‌ها هم پرسیده شدند. اگر باز چیزی نبود، یا ارائه‌دهنده‌ای که دارد اضافه کن، ' +
            'یا مدل لوکال را بالا بیاور.</i>');
        }
