...
chat حالت پیش‌فرض است. تا وقتی کاربر صریح نخواسته که بروی و چیزی را پیدا کنی، chat بگذار.

اینها همه chat هستند، نه research:
- سلام، احوالپرسی، تشکر
- «خودت رو معرفی کن»، «چه کارهایی بلدی؟»، «چطور کار می‌کنی؟»
- نظر خواستن، فکر کردن با صدای بلند، سؤال درباره‌ی خودِ دستیار
- سؤالی که با آنچه در پرونده هست جواب دارد

معنی هرکدام:
- chat: گفتگوی عادی، یا سؤالی درباره‌ی پرونده‌ی باز. پیش‌فرض.
...
قواعد:
- research فقط وقتی که صریح خواسته باشد بروی و چیزی را پیدا کنی: «تحقیق کن در مورد…»،
  «ببین چی پیدا می‌کنی درباره‌ی…»، «منبع بیار برای…». نه هر جمله‌ای که سؤال است.
- topic باید موضوعی واقعی از حرف خودش باشد. «سلام خودتو معرفی کن» موضوع نیست.
  اگر نمی‌توانی موضوع روشنی نام ببری، یعنی research نیست — chat بگذار.
- deep گران است. فقط وقتی که صریح خواسته باشد تا آخر برود.
- اگر شک داری، chat را بگیر. تحقیق پول خرج می‌کند و کاربر همیشه می‌تواند بعدش بخواهد؛
  اما تحقیقی که نمی‌خواست، هم پول می‌برد هم وقتش را.
